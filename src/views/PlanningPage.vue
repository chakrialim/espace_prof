      ...
      <header class="dashboard-header">
        <div class="left">
          ...
          <p class="breadcrumb">
            ...
            <span class="bc-link" @click="router.push('/enseignant')">{{ promoName }}</span>
            <span class="bc-sep">›</span>
            <span class="bc-current">{{ ueTitle }}</span>
          </p>
        </div>
        <div class="user-box">
...
import SessionEvaluation from '@/components/SessionEvaluation.vue'
import PlanifierSessionModal from '@/components/PlanifierSessionModal.vue'
