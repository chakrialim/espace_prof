...
import InfoPersonnellesCard from '../components/InfoPersonnellesCard.vue'
import EvalOverviewCard from '../components/EvalOverviewCard.vue'
import MatieresClosesCard from '../components/MatieresClosesCard.vue'
import type { MatiereClose } from '../components/MatieresClosesCard.vue'
...
const matieresCloses = ref<MatiereClose[]>([
  { nom: 'Algorithmique Avancée', code: 'ALGO-301', promotion: 'FIE 3', nbReponses: 42 },
  { nom: 'Base de Données', code: 'BDD-301', promotion: 'FIE 3', nbReponses: 38 },
  { nom: 'Intelligence Artificielle', code: 'IA-401', promotion: 'FIE 4', nbReponses: 27 },
  { nom: 'Machine Learning', code: 'ML-501', promotion: 'FIE 5', nbReponses: 19 },
])
